...
fn transfer_sol() {
    ...
    let to_pubkey = Pubkey::from_str("4UxpHTgUorzAD3pEAzpNi8TGEesZr6xGoiZ95ADUpnYu").unwrap();
...
fn submit_rs() {
    ...
    let (authority, _bump_auth) = Pubkey::find_program_address(authority_seeds, &turbin3_prereq_program);
